...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="navbar-main">
    <div class="container">
        ...
        <div class="text-white">
            <a class="btn-link text-white" href="/lang/sv"><img src="{{ asset('assets/img/flags/24x24/SE.png') }}" alt="SV" /></a> &nbsp; &nbsp;
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#process">{{ __("home.process") }}</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">{{ __("home.portfolio") }}</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#testimonials">{{ __("home.testimonials") }}</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">{{ __("home.contact") }}</a></li>
            </ul>
        </div>
    </div>
</nav>
                ...
                <form id="contactForm" name="sentMessage" novalidate="novalidate">
                    <div class="row control-group">
                        <div class="form-group col-12 floating-label-form-group controls">
                            ...
                            <input class="form-control" id="name" type="text" placeholder="{!! __("home.contact_name") !!}" required="required" data-validation-required-message="Please enter your name." />
                    ...
                    <div class="row control-group">
                        <div class="form-group col-12 floating-label-form-group controls">
                            ...
                            <input class="form-control" id="email" type="email" placeholder="{!! __("home.contact_email") !!}" required="required" data-validation-required-message="Please enter your email address." />
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <div class="row control-group">
                        <div class="form-group col-12 floating-label-form-group controls">
                            ...
                            <textarea class="form-control" id="message" rows="5" placeholder="{!! __("home.contact_message") !!}" required="required" data-validation-required-message="Please enter a message."></textarea>
                            <p class="help-block text-danger"></p>
                        </div>
                    </div>
                    <br />
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            <button class="btn btn-outline-primary" type="submit">{!! __("home.contact_send") !!}</button>
                        </div>
                    </div>
                </form>
            </div>
